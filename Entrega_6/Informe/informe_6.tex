...
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{multirow} % Permite combinar celdas en múltiples filas dentro de tablas % Proporciona una amplia variedad de entornos y comandos matemáticos
\usepackage{natbib}
\newcommand{\xmark}{\ensuremath{\times}}

% Paquetes adicionales para muros.tex
...
\definecolor{rojono}{RGB}{180,0,0}
\definecolor{gris}{RGB}{100,100,100}
\definecolor{fondotabla}{RGB}{235,242,252}

% Caja de verificación
\newtcolorbox{verbox}[1][]{
  colback=fondotabla, colframe=azul, fonttitle=\bfseries\small,
  title=#1, breakable, left=4pt, right=4pt, top=4pt, bottom=4pt
}

% Macros de estado
\newcommand{\ok}{(\checkmark\;\text{OK})}
\newcommand{\noconf}{No requiere confinamiento~$\checkmark$}
...
%----------------------------------------------------------------------------------------
\HRule\\[0.4cm]
{ \huge \bfseries Informe 6: Diseño de Fundaciones}\\[0.4cm] % Titulo del documento
...
\include{Secciones/intro.tex}
\include{Secciones/bases_diseño.tex}
\include{Secciones/esfuerzos_diseño.tex}
\include{Secciones/combinaciones.tex}
\include{Secciones/metodologia.tex}
\include{Secciones/diseño_verificacion.tex}
\include{Secciones/planta.tex}
\include{Secciones/conclu.tex}


\newpage
\nocite{*}
\bibliographystyle{agsm} % Estilo de la cita (puedes usar 'ieeetr', 'apalike', etc.)
\bibliography{bibliio.bib} % Nombre de tu archivo .bib 
