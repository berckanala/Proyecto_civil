...
Los parámetros del suelo de fundación corresponden a los asignados para el sector en estudio y se resumen en la Tabla~\ref{tab:geotecnicos}.
...
Se establece además como criterio que la zona comprimida bajo cada fundación abarque al menos el 80\% de su longitud, limitando la magnitud del despegue admisible entre la zapata y el suelo.