...
\newpage
\include{secciones_inf/02info_gen.tex}
\newpage
\include{secciones_inf/03estructuracion.tex}
\newpage
\include{secciones_inf/04Materiales.tex}
\newpage
\include{secciones_inf/05normas.tex}
\newpage
\include{secciones_inf/06solicitaciones.tex}
\newpage
\include{secciones_inf/07comb_cargas.tex}
\newpage
\include{secciones_inf/08suelos_params.tex}
\newpage
\include{secciones_inf/09conclu_com.tex}
 
\newpage
\bibliographystyle{plain} % Estilo de la cita (puedes usar 'ieeetr', 'apalike', etc.)
\bibliography{biblio.bib} % Nombre de tu archivo .bib (sin la extensión .bib)
