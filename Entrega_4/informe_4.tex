...
%----------------------------------------------------------------------------------------
\HRule \\[0.4cm]
{ \huge \bfseries Informe 3: Modelación sísmica Etabs}\\[0.4cm] % Titulo del documento
...
\newpage
\include{secciones/0resumen.tex}
...
\include{secciones/2masas.tex}
\include{secciones/3parametros_diseno.tex}
\include{secciones/4espectro_dis.tex}
\include{secciones/5verificacion.tex}
\include{secciones/6resultados_modelo.tex}
\include{secciones/7comparacion.tex}
\include{secciones/8conclu.tex}



\newpage
\bibliographystyle{agsm} % Estilo de la cita (puedes usar 'ieeetr', 'apalike', etc.)
\bibliography{bib.bib} % Nombre de tu archivo .bib 
