...
%----------------------------------------------------------------------------------------
\HRule \\[0.4cm]
{ \huge \bfseries Informe 2: Estructuración}\\[0.4cm] % Titulo del documento
...
\include{secciones/1intro.tex}
\include{secciones/2factores.tex}
\include{secciones/3calculo.tex}
\include{secciones/4Espectro.tex}
\include{secciones/5chequeo.tex}
\include{secciones/6tablas.tex}
\include{secciones/7coef_max.tex}
\include{secciones/8coef_x_y.tex}
\include{secciones/9cortes_min_max.tex}
\include{secciones/10cortes_x_y.tex}
\include{secciones/11control_def.tex}
\include{secciones/12verificacion_rig.tex}
\include{secciones/13acoplamiento.tex}
\include{secciones/15conclu.tex}
